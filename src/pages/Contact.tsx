        ...
        <div className="container-wide">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-8">
              ...
              <a href="https://x.com/ralphyroyale22" target="_blank" rel="noopener noreferrer" className="flex gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm group-hover:text-foreground transition-colors">@ralphyroyale22</p>
                </div>
              </a>
            </div>
